LASTGROUP_NULL("x", ANCHOR_START, "x", 1);
LASTGROUP_NULL("(x)", ANCHOR_START, "x", 2);
...
LASTGROUP_NULL("(?P<x>y)(z)", ANCHOR_START, "yz", 3);
...
LASTGROUP_NULL("(?P<x>y)|(?P<z>w)|u", ANCHOR_START, "u", 3);
